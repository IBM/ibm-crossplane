...
type ConfigurationRevisionInterface interface {
	Create(ctx context.Context, configurationRevision *v1beta1.ConfigurationRevision, opts v1.CreateOptions) (*v1beta1.ConfigurationRevision, error)
	Update(ctx context.Context, configurationRevision *v1beta1.ConfigurationRevision, opts v1.UpdateOptions) (*v1beta1.ConfigurationRevision, error)
	UpdateStatus(ctx context.Context, configurationRevision *v1beta1.ConfigurationRevision, opts v1.UpdateOptions) (*v1beta1.ConfigurationRevision, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ConfigurationRevision, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ConfigurationRevisionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ConfigurationRevision, err error)
...
func (c *configurationRevisions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ConfigurationRevisionList, err error) {
