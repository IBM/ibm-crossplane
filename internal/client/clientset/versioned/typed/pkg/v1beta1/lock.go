...
type LockInterface interface {
	Create(ctx context.Context, lock *v1beta1.Lock, opts v1.CreateOptions) (*v1beta1.Lock, error)
	Update(ctx context.Context, lock *v1beta1.Lock, opts v1.UpdateOptions) (*v1beta1.Lock, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.Lock, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.LockList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Lock, err error)
	LockExpansion
}
...
func newLocks(c *PkgV1beta1Client) *locks {
	return &locks{
		client: c.RESTClient(),
	}
}
...
func (c *locks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Lock, err error) {
	result = &v1beta1.Lock{}
	err = c.client.Get().
		Resource("locks").
		Name(name).
...
func (c *locks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.LockList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.LockList{}
	err = c.client.Get().
		Resource("locks").
...
func (c *locks) Create(ctx context.Context, lock *v1beta1.Lock, opts v1.CreateOptions) (result *v1beta1.Lock, err error) {
	result = &v1beta1.Lock{}
	err = c.client.Post().
		Resource("locks").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *locks) Update(ctx context.Context, lock *v1beta1.Lock, opts v1.UpdateOptions) (result *v1beta1.Lock, err error) {
	result = &v1beta1.Lock{}
	err = c.client.Put().
		Resource("locks").
		Name(lock.Name).
...
func (c *locks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Lock, err error) {
	result = &v1beta1.Lock{}
