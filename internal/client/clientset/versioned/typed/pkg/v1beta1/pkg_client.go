...
import (
	...
	"github.com/crossplane/crossplane/internal/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*PkgV1beta1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new PkgV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*PkgV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &PkgV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new PkgV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *PkgV1beta1Client {
...
// New creates a new PkgV1beta1Client for the given RESTClient.
func New(c rest.Interface) *PkgV1beta1Client {
	return &PkgV1beta1Client{c}
}
...
func (c *PkgV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
