...
var providerrevisionsResource = schema.GroupVersionResource{Group: "pkg.ibm.crossplane.io", Version: "v1", Resource: "providerrevisions"}

var providerrevisionsKind = schema.GroupVersionKind{Group: "pkg.ibm.crossplane.io", Version: "v1", Kind: "ProviderRevision"}
...
func (c *FakeProviderRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *pkgv1.ProviderRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(providerrevisionsResource, c.ns, name), &pkgv1.ProviderRevision{})
...
func (c *FakeProviderRevisions) List(ctx context.Context, opts v1.ListOptions) (result *pkgv1.ProviderRevisionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(providerrevisionsResource, providerrevisionsKind, c.ns, opts), &pkgv1.ProviderRevisionList{})
...
func (c *FakeProviderRevisions) Create(ctx context.Context, providerRevision *pkgv1.ProviderRevision, opts v1.CreateOptions) (result *pkgv1.ProviderRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(providerrevisionsResource, c.ns, providerRevision), &pkgv1.ProviderRevision{})
...
func (c *FakeProviderRevisions) Update(ctx context.Context, providerRevision *pkgv1.ProviderRevision, opts v1.UpdateOptions) (result *pkgv1.ProviderRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(providerrevisionsResource, c.ns, providerRevision), &pkgv1.ProviderRevision{})
...
func (c *FakeProviderRevisions) UpdateStatus(ctx context.Context, providerRevision *pkgv1.ProviderRevision, opts v1.UpdateOptions) (*pkgv1.ProviderRevision, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(providerrevisionsResource, "status", c.ns, providerRevision), &pkgv1.ProviderRevision{})
...
func (c *FakeProviderRevisions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(providerrevisionsResource, c.ns, name), &pkgv1.ProviderRevision{})
...
func (c *FakeProviderRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *pkgv1.ProviderRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(providerrevisionsResource, c.ns, name, pt, data, subresources...), &pkgv1.ProviderRevision{})
