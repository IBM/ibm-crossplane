...
var configurationrevisionsResource = schema.GroupVersionResource{Group: "pkg.ibm.crossplane.io", Version: "v1", Resource: "configurationrevisions"}

var configurationrevisionsKind = schema.GroupVersionKind{Group: "pkg.ibm.crossplane.io", Version: "v1", Kind: "ConfigurationRevision"}
...
func (c *FakeConfigurationRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *pkgv1.ConfigurationRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(configurationrevisionsResource, c.ns, name), &pkgv1.ConfigurationRevision{})
...
func (c *FakeConfigurationRevisions) List(ctx context.Context, opts v1.ListOptions) (result *pkgv1.ConfigurationRevisionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(configurationrevisionsResource, configurationrevisionsKind, c.ns, opts), &pkgv1.ConfigurationRevisionList{})
...
func (c *FakeConfigurationRevisions) Create(ctx context.Context, configurationRevision *pkgv1.ConfigurationRevision, opts v1.CreateOptions) (result *pkgv1.ConfigurationRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(configurationrevisionsResource, c.ns, configurationRevision), &pkgv1.ConfigurationRevision{})
...
func (c *FakeConfigurationRevisions) Update(ctx context.Context, configurationRevision *pkgv1.ConfigurationRevision, opts v1.UpdateOptions) (result *pkgv1.ConfigurationRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(configurationrevisionsResource, c.ns, configurationRevision), &pkgv1.ConfigurationRevision{})
...
func (c *FakeConfigurationRevisions) UpdateStatus(ctx context.Context, configurationRevision *pkgv1.ConfigurationRevision, opts v1.UpdateOptions) (*pkgv1.ConfigurationRevision, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(configurationrevisionsResource, "status", c.ns, configurationRevision), &pkgv1.ConfigurationRevision{})
...
func (c *FakeConfigurationRevisions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(configurationrevisionsResource, c.ns, name), &pkgv1.ConfigurationRevision{})
...
func (c *FakeConfigurationRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *pkgv1.ConfigurationRevision, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(configurationrevisionsResource, c.ns, name, pt, data, subresources...), &pkgv1.ConfigurationRevision{})
