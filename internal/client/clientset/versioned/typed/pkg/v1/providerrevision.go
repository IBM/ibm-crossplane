...
func newProviderRevisions(c *PkgV1Client, namespace string) *providerRevisions {
...
func (c *providerRevisions) Create(ctx context.Context, providerRevision *v1.ProviderRevision, opts metav1.CreateOptions) (result *v1.ProviderRevision, err error) {
	result = &v1.ProviderRevision{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("providerrevisions").
...
func (c *providerRevisions) Update(ctx context.Context, providerRevision *v1.ProviderRevision, opts metav1.UpdateOptions) (result *v1.ProviderRevision, err error) {
	result = &v1.ProviderRevision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("providerrevisions").
...
func (c *providerRevisions) UpdateStatus(ctx context.Context, providerRevision *v1.ProviderRevision, opts metav1.UpdateOptions) (result *v1.ProviderRevision, err error) {
	result = &v1.ProviderRevision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("providerrevisions").
...
func (c *providerRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ProviderRevision, err error) {
	result = &v1.ProviderRevision{}
